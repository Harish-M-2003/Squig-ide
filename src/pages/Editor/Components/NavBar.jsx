...
export default function EditorNavBar({Code , content , setFile ,  current_files , current_tab_name}){
...
//   };
    ...
    return (
      <>
        ...
        <div className='flex gap-10 pl-5 p-[0.5em] border-b border-gray-700'>
          <img src={logo} className='h-[1.5rem] w-[1.5rem]'></img>
            <Menu menuStyle={{
            ...
            menuButton={<MenuButton>Files</MenuButton>}>
                <MenuItem
                  className={"hover:bg-gray-900"}
                  onClick={() => {newFile(Code , "squig.txt")}}
                >
                    New File
                </MenuItem>
                <MenuItem
                ...
                <MenuItem
                  className={"hover:bg-gray-900"}
                  onClick={() => console.log("saving file")}
                >Save</MenuItem>
        ...
        <TaskBar filenames={current_files} setDisplayCode = {Code} setTabName = {current_tab_name}/>
        </>
    );
